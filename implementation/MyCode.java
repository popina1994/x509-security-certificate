...
public class MyCode extends CodeV3 {
	...
	public int loadKeypair(String alias) {
		...
		access.setAuthorityKeyID(certificate.getCertificateV3Extension().getExtKeyIdentifiers().getAuthorityKeyIdentifier());
		access.setAuthorityIssuer(certificate.getCertificateV3Extension().getExtKeyIdentifiers().getIssuer());
		access.setAuthoritySerialNumber(certificate.getCertificateV3Extension().getExtKeyIdentifiers().getSerialNumber());
